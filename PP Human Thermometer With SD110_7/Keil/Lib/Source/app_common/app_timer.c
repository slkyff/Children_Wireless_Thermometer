...
//uint8_t                       m_user_array_size;                         /**< Size of timer user array. */
//timer_user_t *                mp_users;                                  /**< Array of timer users. */
//app_timer_id_t                m_timer_id_head;                           /**< First timer in list of running timers. */
//uint32_t                      m_ticks_latest;                            /**< Last known RTC counter value. */
//uint32_t                      m_ticks_elapsed[CONTEXT_QUEUE_SIZE_MAX];   /**< Timer internal elapsed ticks queue. */
//uint8_t                       m_ticks_elapsed_q_read_ind;                /**< Timer internal elapsed ticks queue read index. */
//uint8_t                       m_ticks_elapsed_q_write_ind;               /**< Timer internal elapsed ticks queue write index. */
