...
#define PSTORAGE_USER_DATA_PAGE_CNT 50															//暂时使用50个Page用于用户数据,48个用于离线数据，1个用于厂商信息区，1个用于Device Manager区

#define PSTORAGE_DATA_START_ADDR    ((PSTORAGE_FLASH_PAGE_END - PSTORAGE_USER_DATA_PAGE_CNT - 1) \
