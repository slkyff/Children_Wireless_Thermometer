...
#define DFU_DUAL_BANK_REGION_ADDR_END   0x0002F400

#define DFU_REGION_TOTAL_SIZE           (DFU_DUAL_BANK_REGION_ADDR_END - CODE_REGION_1_START)           /**< Total size of the region between SD and Bootloader. */
